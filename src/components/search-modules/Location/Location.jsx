    ...
    >
      ...
      {activeRadio === 'search-location-zip' && (
        <div className="search-location__zip">
          <TextInput id="search-location-zip-input" classes="search-location__zip --zip" label="U.S. ZIP Code" />
          <Dropdown id="search-location-radius" classes="search-location__zip --radius" label="Radius">
      ...
      {activeRadio === 'search-location-country' && (
        <div className="search-location__country">
          <Dropdown classes="search-location__country --country" label="Country">
            {['United States', 'United Kingdom', 'Zambia', 'Japan', 'Uruguay'].map(city => {
              return <option key={city} value={city}>{`${city}`}</option>;
            })}
          </Dropdown>
          <div className="search-location__country --city-and-state">
            <TextInput id="search-location-state" classes="search-location__country --state" label="State" />
            <TextInput id="search-location-city" classes="search-location__country --city" label="City" />
          </div>
        </div>
      )}
      {!limitToVA && (
