...
##########################################################
DRUSH_PATHS_CACHE_DIRECTORY=$cacheDir $blt cgov:acsf:db-update --environment=$env --site=${name[0]} --define drush.uri=$domain --verbose --no-interaction -D drush.ansi=false
