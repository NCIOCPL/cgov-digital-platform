Feature: Create Article
    ...
    Scenario: Create published and draft cgov_article
        ...
        And browser waits
    When user navigates to "/admin/content"
    Then user clicks on "Content" tab
    And user clicks on "Add content" action button
    And user clicks on "Article" content type
    Then page title is "Create Article"
    ...
    Scenario: Create cgov_home_landing
        ...
        Scenario: Verify display of featured content in promo blocks 
        Given user navigates to "test-site-section/home-landing-promo-blocks"
