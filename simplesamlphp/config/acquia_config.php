...
// Retrieve secrets.
$secrets_location = sprintf('/mnt/files/%s.%s/secrets.settings.php', $_ENV['AH_SITE_GROUP'],$_ENV['AH_SITE_ENVIRONMENT']);
if (file_exists($secrets_location)) {
  require $secrets_location;
}
