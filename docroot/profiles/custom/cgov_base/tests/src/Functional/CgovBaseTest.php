...
namespace Drupal\Tests\cgov_base\Functional;
...
/**
 * Tests cgov_base installation profile expectations.
 *
 * @group cgov_base
 */
class cgov_baseTest extends BrowserTestBase {
  ...
  /**
   * Tests cgov_base installation profile.
   */
  public function testcgov_base() {
    $this->drupalGet('');
    ...
    // cgov_base profile modules are enabled.
    ...
    // Ensure that configuration from the cgov_base profile is not reused when
