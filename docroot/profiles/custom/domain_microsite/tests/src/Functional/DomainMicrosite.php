...
namespace Drupal\Tests\domain_microsite_domain\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Tests domain_microsite_domain installation profile expectations.
 *
 * @group domain_microsite_domain
 */
class domain_microsite_domainTest extends BrowserTestBase {

  protected $profile = 'domain_microsite_domain';

  /**
   * Tests domain_microsite_domain installation profile.
   */
  public function testdomain_microsite_domain() {
    $this->drupalGet('');
