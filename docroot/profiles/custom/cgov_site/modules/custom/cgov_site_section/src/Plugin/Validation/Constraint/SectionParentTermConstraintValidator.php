...
/**
 * This class validates that only one parent is selecting, restricting multiple selection of parent and displaying an error to the end user.
 *
...
class SectionParentTermConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
  ...
  /**
   * Constructs an SectionParentTermConstraintValidator object.
   *
  ...
  public static function create(ContainerInterface $container) {
    return new static(
        $container->get('entity_type.manager'), $container->get('language_manager')
      );
  }
