...
describe('processSelectedSuggestions', () => {
  ...
  describe('when checkbox is checked (selected)', () => {
    ...
    it('should maintain preexisting term', () => {
      ...
      const parser = new window.DOMParser();
      const contentDoc = parser.parseFromString(
        `Placeholder <label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term glossify-dialog__term--first" data-preexisting="true" data-html="" data-glossify-label="">cancer<input type="checkbox" checked></label> Placeholder`,
        'text/html'
      );

      const actual = processSelectedSuggestions(contentDoc.body);
      const expected = `Placeholder <a data-glossary-id=\"CDR0000045333\" class=\"definition\" href=\"/Common/PopUps/popDefinition.aspx?id=CDR0000045333&amp;version=Patient&amp;language=en\">cancer</a> Placeholder`;
    ...
    it('should restore html tags', () => {
      ...
      const parser = new window.DOMParser();
      const contentDoc = parser.parseFromString(
        `Placeholder <label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term glossify-dialog__term--first" data-preexisting="true" data-html="strong,em" data-glossify-label="">cancer<input type="checkbox" checked></label> Placeholder`,
        'text/html'
      );

      const actual = processSelectedSuggestions(contentDoc.body);
      const expected = `Placeholder <a data-glossary-id=\"CDR0000045333\" class=\"definition\" href=\"/Common/PopUps/popDefinition.aspx?id=CDR0000045333&amp;version=Patient&amp;language=en\"><em><strong>cancer</strong></em></a> Placeholder`;
    ...
    it('should process multiple selected terms', () => {
      const parser = new window.DOMParser();
      const contentDoc = parser.parseFromString(
        `Placeholder <label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term glossify-dialog__term--first" data-preexisting="false" data-html="" data-glossify-label="">cancer<input type="checkbox" checked></label> Placeholder` +
        `<label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term " data-preexisting="false" data-html="" data-glossify-label="">cancer<input type="checkbox" checked></label> Placeholder`,
        'text/html'
      );

      const actual = processSelectedSuggestions(contentDoc.body);
      const expected = `Placeholder <a data-glossary-id="CDR0000045333" class="definition" href="/Common/PopUps/popDefinition.aspx?id=CDR0000045333&amp;version=Patient&amp;language=en">cancer</a> Placeholder` +
        `<a data-glossary-id="CDR0000045333" class="definition" href="/Common/PopUps/popDefinition.aspx?id=CDR0000045333&amp;version=Patient&amp;language=en">cancer</a> Placeholder`;
  ...
  describe('when checkbox is unchecked (not selected)', () => {
    it('should restore unselected term as basic text for non-preexisting term', () => {
      const parser = new window.DOMParser();
      const contentDoc = parser.parseFromString(
        `Placeholder <label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term glossify-dialog__term--first" data-preexisting="false" data-html="" data-glossify-label="">cancer<input type="checkbox"></label> Placeholder`,
        'text/html'
      );
    ...
    it('should remove preexisting term', () => {
      ...
      const parser = new window.DOMParser();
      const contentDoc = parser.parseFromString(
        `Placeholder <label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term glossify-dialog__term--first" data-preexisting="true" data-html="" data-glossify-label="">cancer<input type="checkbox"></label> Placeholder`,
        'text/html'
      );
    ...
    it('should remove preexisting term and restore HTML', () => {
      ...
      const parser = new window.DOMParser();
      const contentDoc = parser.parseFromString(
        `Placeholder <label data-term-id="CDR0000045333" data-language="en" class="glossify-dialog__term glossify-dialog__term--first" data-preexisting="true" data-html="strong,em" data-glossify-label="">cancer<input type="checkbox"></label> Placeholder`,
        'text/html'
      );
