...
<div class="cgdp-profile-box cgdp-profile-box--cancer-center">
	<div class="grid-row grid-gap-lg">
		...
		<div class="tablet:grid-col-8">
			<h1 class="cgdp-profile-box__heading">Duke Cancer Center</h1>
        <div class="cgdp-profile-box__field usa-prose">
					<ul class="cgdp-profile-box__titles">
						<li class="cgdp-profile-box__title">Duke University Medical Center</li>
						<li class="cgdp-profile-box__title">Comprehensive Cancer Center</li>
					</ul>
					<div class="cgdp-profile-box__address">Michael B. Kastan, M.D., Ph.D., Executive Director</div>
