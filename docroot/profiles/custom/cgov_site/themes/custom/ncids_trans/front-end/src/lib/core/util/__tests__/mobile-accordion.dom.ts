export const accordionPresentOnPage = `
<aside class="cgdp-related-resources usa-accordion usa-accordion--multiselectable" data-allow-multiple="">
  <h2 class="nci-heading-h2 usa-accordion__heading"><button class="usa-accordion__button" aria-controls="acc5858" type="button" aria-expanded="false">Related Resources</button></h2>
	<div class="usa-accordion__content" id="acc5858" hidden="">
...
export const accordionNotPresentOnPage = `
