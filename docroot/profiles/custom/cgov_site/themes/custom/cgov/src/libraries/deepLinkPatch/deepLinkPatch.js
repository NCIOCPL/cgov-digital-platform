...
function _initialize() {
  ...
  window.addEventListener('nci.accordion.create', function (event) {
    console.log('Deeplink: Accordion Created');

    if (!location.hash) {
      console.log('Deeplink: no hash stop processing');
      return;
    }
  ...
  window.addEventListener('hashchange', function(event) {
    ...
    console.log('Deeplink: Hashchange');
 ...
 */
 const findAndExpandAnchorInAccodion = (anchorId, activeAccordion = null) => {
  ...
  if (!anchorEl) {
    console.log(`Deeplink: No anchor found, ${anchorId}`);
  ...
  if (!accordion || (activeAccordion !== null && accordion !== activeAccordion)) {
    console.log('Deeplink: Accordion does not match');
  ...
  if (!accordionSection) {
    console.log('Deeplink: No parent accodion section to anchor.');
