...
function initChart(Chart) {
  new Chart(id, {
    ...
    series: [{
      name: 'Funds',
      yAxis: 0,
      data: [5058, 5067, 4789, 4932, 4953, 5206, 5636,5928, 5992, 6383],
      tooltip: { valuePrefix: '$', valueSuffix: ',000' }
    }, {
      name: 'Space (Sq Ft)',
      yAxis: 1,
      data: [952, 952, 1072, 992, 1011, 1001, 1004, 1019, 1055, 1212],
      tooltip: { pointFormat: '<span style="color:{point.color}">\u25CF</span> Space: {point.y}<br/>' }
    }, {
      name: 'FTEs',
      yAxis: 2,
      data: [3135, 3136, 3103, 3040, 2998, 2962, 3029, 2952, 2888, 2993]
    }]
  });
};
