...
$(document).ready(function() {
    ...
    // SITEWIDE SEARCH RESULTS: Result Link Click Handler.
    registerCustomEventListener('NCI.sitewide-search-results-result.click', (_, args) => {
      NCIAnalytics.SiteWideSearchResults(...args);
    });

    // SITEWIDE SEARCH RESULTS: Results Load.
    registerCustomEventListener('NCI.sitewide-search-results.load', (_, args) => {
      // TODO: What do we do now??
      console.log('Unmanaged event for results page load detected', args)
    });
