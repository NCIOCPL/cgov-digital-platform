...
class BasicMigrationTransformerTest extends UnitTestCase {
  ...
  public function testCalloutBoxWithInvalidClass(): void {
    ...
    $expected = '<div class="callout-box invalid-class">Content</div>';
  ...
  public function testStyleTransformation(): void {
    ...
    $output = $this->transformerManager->transformAll($input);
    $expected = '<div>Container<span>Text</span><table style="width: 100%; background-color: #fff; margin: 10px; invalid-prop: value;"><tr style="text-align: center; color: red;"><td style="padding: 5px; font-size: large;">Cell Content</td></tr></table></div>';
