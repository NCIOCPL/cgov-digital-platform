...
namespace Drupal\Tests\ncids_html_transformer\Unit\Plugin\Services;
...
class BasicMigrationTransformerTest extends UnitTestCase {
  ...
  public function testCalloutBoxWithInvalidClass(): void {
    ...
    $expected = '<div class="callout-box invalid-class" data-html-transformer="summary-box">Content</div>';
  ...
  public function testNestedInvalidClasses(): void {
    ...
    $output = $this->transformerManager->transformAll($input);
    $expected = '<div class="callout-box" data-html-transformer="summary-box"><div class="invalid1"><p class="invalid2">Text</p></div></div>';
  ...
  public function testTableWithAllowedStyles(): void {
    ...
    $output = $this->transformerManager->transformAll($input);
    $expected = '<table class="complex-table" style="width: 100%; background-color: #fff;" data-html-transformer="complex-table"><tr style="text-align: center;"><td>Content</td></tr></table>';
  ...
  public function testCalloutBoxVariations(): void {
    ...
    $output = $this->transformerManager->transformAll($input);
    $expected = '<div class="callout-box-center invalid" data-html-transformer="summary-box"><aside class="callout-box-right wrong" data-html-transformer="summary-box">Right Box</aside></div>';
  ...
  public function testMixedContentWithTextNodes(): void {
    ...
    $output = $this->transformerManager->transformAll($input);
    $expected = '<div class="callout-box" data-html-transformer="summary-box">Text <span class="invalid">More</span> <p class="wrong">Text</p></div>';
  ...
  public function testComplexNestedStructure(): void {
    ...
    $output = $this->transformerManager->transformAll($input);
    $expected = '<div class="grid-container"><div class="grid-row"><div class="grid-col-6"><table class="complex-table invalid" data-html-transformer="complex-table"><tr class="wrong"><td class="text-left bad" style="text-align: center;">Content</td></tr></table></div></div></div>';
