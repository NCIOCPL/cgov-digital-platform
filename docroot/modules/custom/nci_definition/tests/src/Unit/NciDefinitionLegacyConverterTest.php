...
class NciDefinitionLegacyConverterTest extends TestCase {
  ...
  public function testConvertPdqHpGeneticsDefinitionLink() {
    ...
    $output = $converter->convert($input);
    // You are going to change this.
    $expected = '<nci-definition data-gloss-id="339347" data-gloss-dictionary="Cancer.gov" data-gloss-audience="Health Professional" data-gloss-lang="en">sporadic</nci-definition>';
