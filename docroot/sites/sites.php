...
// Define the MEO site name global variable
global $_meo_site_name;
$site_name = $sites[$_SERVER['HTTP_HOST']];
$_meo_site_name = getenv($site_name . '_LEGACY_SITE_NAME') ?: ($_ENV['AH_SITE_GROUP'] ?? NULL);

$sitesPostFiles = [
  DRUPAL_ROOT . '/sites/post_sites_includes.php',
];
foreach ($sitesPostFiles as $sitesFile) {
